...
void ThreadCli()
{
    ...
    printf("HappinessIndex CLI ready:\n> ");
    fflush(stdout);
...
void WaitForShutdown(boost::thread_group* threadGroup)
{
    ...
    LogPrintf("HappinessIndex shutdown.\n\n");
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to HappinessIndexd / RPC client
            std::string strUsage = _("HappinessIndex version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  HappinessIndexd [options]                     " + "\n" +
                  "  HappinessIndexd [options] <command> [params]  " + _("Send command to -server or HappinessIndexd") + "\n" +
                  "  HappinessIndexd [options] help                " + _("List commands") + "\n" +
                  "  HappinessIndexd [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "HappinessIndex:"))
                fCommandLine = true;
...
int main(int argc, char* argv[])
{
    ...
    // Connect HappinessIndexd signal handlers
    noui_connect();
