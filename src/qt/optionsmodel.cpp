...
void OptionsModel::Init()
{
    ...
    fAutoRedeemAnon = settings.value("fAutoRedeemAnon", false).toBool();
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemAnon: return "AutoRedeemAnon";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemAnon: {
            fAutoRedeemAnon = value.toBool();
            settings.setValue("fAutoRedeemAnon", fAutoRedeemAnon);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemAnon() { return fAutoRedeemAnon; }
