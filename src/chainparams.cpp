...
public:
    CBaseChainParams() {
        const char* pszTimestamp = "2 28,2018. The HappinessIndex released, www.HappinessIndex.org";
        CTransaction txNew;
        ...
        genesis.nTime    = GENESIS_BLOCK_TIME;
             ...
             vSeeds.push_back(CDNSSeedData("47.75.63.17",  "47.75.63.17"));
		vSeeds.push_back(CDNSSeedData("47.91.216.181",  "47.91.216.181"));
...
public:
    CMainParams() {
      ...
      //  nLastPOWBlock = std::numeric_limits<int>::max();
        ...
        genesis.nNonce   = 15321;
        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x6df9ed5059eeb96b91336647f030643159d8c0ad5ea7c8942cb53adef38f72d5"));
        assert(genesis.hashMerkleRoot == uint256("0x270e908c03cbe959a74d1422325756053cdcb5e64732db73c4281998b5a61002"));
...
public:
    CTestNetParams() {
        ...
        assert(hashGenesisBlock == uint256("0x83bd64fa82248404b573ca22fed2ec00767f0499b0c3dc14d5a347136ce2b02c"));
...
public:
    CRegTestParams() {
        ...
        genesis.nTime = 1525315923;
        genesis.nBits  = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 4;
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 18444;

        assert(hashGenesisBlock == uint256("0x64e0f0dd0f5e6e205f4949cbdf53d9d0b3702698cbaab0e4936fd56473c8a40d"));
